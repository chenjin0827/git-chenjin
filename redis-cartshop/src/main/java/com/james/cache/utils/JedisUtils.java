...
import com.james.cache.basic.JedisConstants;
...
public class JedisUtils {
	...
	private String ip = JedisConstants.ip;
	private int port = JedisConstants.port;
	private String auth = JedisConstants.auth;
