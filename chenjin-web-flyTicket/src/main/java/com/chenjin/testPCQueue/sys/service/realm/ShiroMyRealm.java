...
import com.chenjin.testPCQueue.common.ca.CommonCA;
import com.chenjin.testPCQueue.common.cache.dao.ShiroSessionDAO;
...
import com.chenjin.testPCQueue.sys.service.IAttributeItemService;
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        if (user != null)
        {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                com.chenjin.testPCQueue.sys.entity.Resource r = (com.chenjin.testPCQueue.sys.entity.Resource)this.resourceService.getById(resourceId);
