...
public class XmlConverUtil
{
            ...
            throws Exception
    {
        ...
        for (Iterator localIterator1 = list.iterator(); localIterator1.hasNext(); ) { Object o = localIterator1.next();
            ...
            if ((o instanceof Map)) {
                for (localIterator2 = ((Map)o).keySet().iterator(); localIterator2.hasNext(); ) { Object obj = localIterator2.next();
                    Element keyElement = nodeElement.addElement("key");
                    keyElement.addAttribute("label", String.valueOf(obj));
    ...
    {
        System.out.println(jsontoXml("{'cxksrq':'2016-06-12','cxjsrq':'2016-07-12','yybm':'PDY310384'}"));
    }
}