...
public class MenuController extends BaseController
{
    ...
    public List<Menu> list(String sysId, String orgType, PageRequest pageable, @CurrentUser User currentUser)
    {
        ...
        for (Menu menu : list) {
            com.chenjin.sys.entity.Resource r = (com.chenjin.sys.entity.Resource)this.resourceService.getById(CommonProperties.MAIN_PROJECTDS, menu.getResourceId());
    ...
    @ResponseBody
    public DataGrid<com.chenjin.sys.entity.Resource> resourcePage(String sysId, String orgType, Long parentId, PageRequest pageable, @CurrentUser User user)
    {
    ...
    public List<Menu> lvlone(String orgType, PageRequest pageable, @CurrentUser User user)
    {
        ...
        for (Menu menu : list) {
            com.chenjin.sys.entity.Resource r = (com.chenjin.sys.entity.Resource)this.resourceService.getById(menu.getResourceId());
    ...
    public String add(String sysId, String orgType, Long parentId, Model model, @CurrentUser User user)
    {
        ...
        if (parentId.longValue() == -1L) {
            ...
            if (m.getName() != null) {
                ...
                com.chenjin.sys.entity.Resource r = (com.chenjin.sys.entity.Resource)this.resourceService.getById(user.getProjectCode(), m.getResourceId());
