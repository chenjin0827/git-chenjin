...
location.href = "${pageContext.request.contextPath }/home/index.htmlx";
    ...
    <script  type="text/javascript" src="<c:out value='${pageContext.request.contextPath }'/>/resources/js/jquery-easyui/locale/easyui-lang-zh_CN.js"></script>  
  	<script type="text/javascript" src="<c:out value='${pageContext.request.contextPath }'/>/resources/js/jquery-easyui/myVali.js"></script>
...
<div id="backgrounddiv" class="backgrounddiv">
	...
	<div id="footer" class="footer" style="color:#999;text-align:center;font-size:10px;line-height: 30px;"></div>
</div>
