...
<script language="javascript">
  function txtclear()
  {
   ...
   function aaaclear()
  {
    document.pricesearch.aaa.value="";
  }
  
   function bbbclear()
  {
    document.pricesearch.bbb.value="";
  }
  ...
  function tijiao2()
  {
    var key = document.pricesearch.aaa.value;
    var key1 = document.pricesearch.bbb.value;
    if(key.trim()=="")
    {
      alert("关键字不能为空");
      return;
...
<form name="mfsearch" method="post" action="${ pageContext.request.contextPath }/product_findByPname.action?page=1">
 	<table id="soushuo" border="0"  >
	  <tr>
	    <td>
	      <input id="soushuokuang" type="text" name="tsearch"  style="width:500px; height:23px"  value="请输入要搜索的关键字" onfocus="txtclear()"/>
...
<!-- cbahs -->
<form name="pricesearch" method="post" action="${ pageContext.request.contextPath }/product_findByPrice.action?page=1">
 	<table   id="jiage" border="0"  >
	  <tr>
	    <td>
	      <input style="width:50px; height:23px" type="text" id="aaa" name="low" value="最低价" onfocus="aaaclear()"/>-
	      <input style="width:50px; height:23px" type="text" id="bbb" name="high" value="最高价" onfocus="bbbclear()" />
	       <input type="hidden" name="action" value="search"/>
	  	    <input type="button" id="csearch" name="csearch" value="搜索" onclick="tijiao2()"/>
	    </td>
	  </tr>
	  <tr>
	  	<td align="right">
...
<%-- <div class="container footer">
	...
	<!-- <table >
 <tr class="shiwu"  align="center">   版权所有：哈尔滨学院&nbsp;&nbsp;&nbsp;&nbsp; 地址： 哈尔滨学院2701工作室 &nbsp;&nbsp;&nbsp;&nbsp;  邮编： 150086</tr><br/>

     <tr><a    class="a1-2 " href="#">联系商家电话：15546497878</a></tr>
