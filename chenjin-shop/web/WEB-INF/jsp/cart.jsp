					...
					<tr>
						...
						<tr>
							...
							<td class="quantity" width="60">
								<s:property value="#cartItem.count"/><a href="${ pageContext.request.contextPath }/cart_addcount.action?pid=<s:property value="#cartItem.product.pid"/>&count=<s:property value="#cartItem.count"/>">+</a>
							</td>
							<td width="140">
