...
public class TestItextPdf {
    ...
    public static void makePdf() throws Exception {
        ...
        table.addCell(myCell4("甲方(医疗机构)：" + "草埠湖中心医院"));
        //table.addCell(myCell("确认时间: "+today));
        table.addCell(myCell(" "));
        table.completeRow();

        table.addCell(myCell4("乙方(药品集团采购组织)：" + "全药网"));
        //table.addCell(myCell("确认时间: "));
        table.addCell(myCell(" "));
        table.completeRow();

        table.addCell(myCell4("丙方(配送企业)：" + "草埠湖供应商"));
        //table.addCell(myCell("确认时间: "));
        table.addCell(myCell(" "));
        table.completeRow();
        document.add(table);
        ...
        table.addCell(myCell1("全药网"));
        table.addCell(myCell1("签名同意合同"));
        table.addCell(myCell1(" "));
        table.addCell(myCell1(" "));
        table.completeRow();

        table.addCell(myCell1("配送商"));
        table.addCell(myCell1("签名同意合同"));
        table.addCell(myCell1(" "));
        table.addCell(myCell1(" "));
        table.completeRow();
...
//        String fileId = gridFSDAO.saveFile(f, "contract_" + c.getCode() + ".pdf", "contract");
    ...
    public static Font setChineseFont(float size, int bold) {
        BaseFont bf = null;
    ...
    private static PdfPCell myCell4(String s) {
    ...
    private static PdfPCell myCell(String s) {
    ...
    private static PdfPCell myCell3(String s) {
    ...
    private static PdfPCell myCell1(String s) {
    ...
    private static PdfPCell myCell2(String s) {
        PdfPCell c = new PdfPCell(new Phrase(s, setChineseFont()));
        c.setNoWrap(true);
