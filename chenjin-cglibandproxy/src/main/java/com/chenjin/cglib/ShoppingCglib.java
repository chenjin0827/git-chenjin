 ...
 */
public class ShoppingCglib implements MethodInterceptor {
    ...
    public static void main(String[] args) {
        ...
        ShoppingCglib shoppingCglib = new ShoppingCglib();
        Shopping instance = (Shopping) shoppingCglib.getInstance(shoppingImpl);
        instance.buy();
    }
}
